 ...
 */
public class MystorebackofficeManager extends GeneratedMystorebackofficeManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(MystorebackofficeManager.class.getName());
	 ...
	 */
	public static MystorebackofficeManager getInstance()
	{
		return (MystorebackofficeManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(MystorebackofficeConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public MystorebackofficeManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of MystorebackofficeManager called.");
		}
	}
