...
public class DefaultMystorecoreService implements MystorecoreService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultMystorecoreService.class);
	...
	{
		return DefaultMystorecoreService.class.getResourceAsStream("/mystorecore/sap-hybris-platform.png");
	}
