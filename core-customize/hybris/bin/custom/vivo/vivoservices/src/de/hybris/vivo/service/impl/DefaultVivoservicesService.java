...
public class DefaultVivoservicesService implements VivoservicesService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultVivoservicesService.class);
	...
	{
		return DefaultVivoservicesService.class.getResourceAsStream("/vivoservices/sap-hybris-platform.png");
	}
