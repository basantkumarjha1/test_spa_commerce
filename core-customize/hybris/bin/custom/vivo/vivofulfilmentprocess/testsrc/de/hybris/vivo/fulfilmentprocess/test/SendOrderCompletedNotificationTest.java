...
import de.hybris.vivo.fulfilmentprocess.actions.order.SendOrderCompletedNotificationAction;
...
public class SendOrderCompletedNotificationTest
{
	...
	/**
	 * Test method for
	 * {@link de.hybris.vivo.fulfilmentprocess.actions.order.SendOrderCompletedNotificationAction#executeAction(OrderProcessModel)}
	 * .
	 */
	@Test
