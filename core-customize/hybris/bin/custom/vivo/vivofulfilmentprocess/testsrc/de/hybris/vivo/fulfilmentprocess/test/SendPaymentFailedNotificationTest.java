...
import de.hybris.vivo.fulfilmentprocess.actions.order.SendPaymentFailedNotificationAction;
...
public class SendPaymentFailedNotificationTest
{
	...
	/**
	 * Test method for
	 * {@link de.hybris.vivo.fulfilmentprocess.actions.order.SendPaymentFailedNotificationAction#executeAction(OrderProcessModel)}
	 * .
	 */
	@Test
