...
public class DefaultMystoreservicesService implements MystoreservicesService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultMystoreservicesService.class);
	...
	{
		return DefaultMystoreservicesService.class.getResourceAsStream("/mystoreservices/sap-hybris-platform.png");
	}
