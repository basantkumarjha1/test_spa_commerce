...
public class DefaultMystorefacadesService implements MystorefacadesService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultMystorefacadesService.class);
	...
	{
		return DefaultMystorefacadesService.class.getResourceAsStream("/mystorefacades/sap-hybris-platform.png");
	}
